...
public class UserDataLoader {
    ...
    CommandLineRunner loadUserData(UserRepository userRepository) {
        return _ -> {
            ...
            User user2 = new User(1L, "Jane Doe", UserRole.PARENT, List.of(1L, 2L));
            User user3 = new User(2L, "Alice", UserRole.PARENT, List.of(3L, 4L));
            User user4 = new User(2L, "Bob", UserRole.PARENT, List.of(5L, 6L));
